  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        <div className="sidebar__section-label mono">— navegação</div>
        {CATEGORIES.map((c, i) => {
      ...
      <div className="sidebar__theme">
        <div className="sidebar__section-label mono">— aparência</div>
        <div className="themetoggle">
          ...
          >
            <Icon name="sparkles" size={14} /> Claro
          </button>
        </div>
      ...
      <div className="sidebar__foot mono">
        <span>STATUS</span>
        <span className="dot dot--ok" /> operacional
      </div>
    </aside>
  );
}
